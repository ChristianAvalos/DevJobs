            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            <a class="text-3xl font-extrabold text-gray-600 dark:text-gray-200 " href="{{route('vacantes.show',$vacante->id)}}">
                                {{$vacante->titulo}}
                            </a>
                            <p class="text-base text-gray-600 dark:text-gray-200 mb-3">
                                {{$vacante->empresa}}
                            </p>
                            <p class="text-xs font-bold text-gray-600 dark:text-gray-200 mb-3">
                                {{$vacante->categoria->categoria}}
                            </p>
                            <p class="text-base text-gray-600 dark:text-gray-200 mb-3">
                                {{$vacante->salario->salario}}
                            </p>
                            <p class="font-bold text-xs text-gray-600 dark:text-gray-200 mb-1">
                ...
                @empty
                    <p class="p-3 text-center text-sm text-gray-600 dark:text-gray-200">No hay vacantes aun</p>
                @endforelse
            </div>
        </div>
    </div>
